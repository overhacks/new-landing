export const useColorTheme = () => {
  const webColors = {
      ...
      FinishedHackatonSlide: "0px 98px 100px 0px rgba(30, 144, 62, 0.12) inset, 0px 4px 18px 0px rgba(30, 120, 82, 0.57) inset, 0px 1px 18px 0px rgba(185, 255, 168, 0.23) inset",
